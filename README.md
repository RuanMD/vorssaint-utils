...
- **Menu bar organizer.** Split status items into visible, hidden and
  ...
  collect related items into quick groups with optional menu bar icons.
  Reveal hidden items in the real menu bar or a searchable secondary bar,
  with keyboard-first search, optional hover, empty-space click, scroll and
